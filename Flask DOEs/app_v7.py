...
# Função para calcular o progresso do processamento
def calcular_progresso(total_arquivos, contador_arquivos):
    if total_arquivos == 0:
        return 0
    return contador_arquivos / total_arquivos

# Função para atualizar a barra de progresso e retornar o progresso atual como uma resposta JSON
